...
public abstract class DatabaseTest {
    ...
    @BeforeEach
    void 테이블을_비운다() {
        dsl.execute("TRUNCATE code_run, idempotency_record, turn_tool_call, turn_file_change, attempt_turn, attempt_file, attempt, guest_session, problem_file, problem, sync_state, users RESTART IDENTITY CASCADE");
