    ...
    <header className={headerClasses}>
      ...
      >
        <div className="flex items-center gap-7 max-[760px]:flex-col max-[760px]:items-stretch max-[760px]:gap-0">
          <NavLink className={(state) => `${getMenuLinkClasses(state)} max-[760px]:px-3 max-[760px]:py-3`} end to="/problems" onClick={closeMenu}>
            PROBLEM LIST
          </NavLink>
          <NavLink className={(state) => `${getMenuLinkClasses(state)} max-[760px]:px-3 max-[760px]:py-3`} to="/relay" onClick={closeMenu}>
            RELAY
          </NavLink>
          <NavLink className={(state) => `${getMenuLinkClasses(state)} max-[760px]:px-3 max-[760px]:py-3`} to="/ranking" onClick={closeMenu}>
            RANKING
          </NavLink>
        </div>
        ...
        {!loading && (
          <>
            <span className="text-[#555] max-[760px]:hidden" aria-hidden="true">
              |
            </span>
            <div className="flex items-center gap-7 max-[760px]:mt-1 max-[760px]:flex-col max-[760px]:items-stretch max-[760px]:gap-0 max-[760px]:border-t max-[760px]:border-[#343434] max-[760px]:pt-1">
              {user ? (
                <>
                  <NavLink className={(state) => `${getMenuLinkClasses(state)} max-[760px]:px-3 max-[760px]:py-3`} to="/my" onClick={closeMenu}>
                    MY PAGE
                  </NavLink>
                  <button
                    className={`${menuItemClasses} cursor-pointer border-0 bg-transparent p-0 font-[inherit] tracking-[inherit] text-[#a3a3a3] max-[760px]:px-3 max-[760px]:py-3 max-[760px]:text-left`}
                    type="button"
                ...
                <>
                  <NavLink className={(state) => `${getMenuLinkClasses(state)} max-[760px]:px-3 max-[760px]:py-3`} to="/login" onClick={closeMenu}>
                    LOGIN
                  </NavLink>
                  <NavLink className={(state) => `${getMenuLinkClasses(state)} max-[760px]:px-3 max-[760px]:py-3`} to="/signup" onClick={closeMenu}>
                    SIGN UP
                  </NavLink>
                </>
              )}
        ...
        <div className="flex items-center max-[760px]:mt-1 max-[760px]:border-t max-[760px]:border-[#343434] max-[760px]:pt-1">
          <button
            aria-label={`헤더에서 ${colorMode === 'dark' ? '라이트' : '다크'} 모드로 전환`}
            aria-pressed={colorMode === 'light'}
            className={`${menuItemClasses} header-theme-toggle inline-flex cursor-pointer items-center gap-1.5 border-0 bg-transparent p-0 font-[inherit] tracking-[inherit] text-[#a3a3a3] max-[760px]:w-full max-[760px]:px-3 max-[760px]:py-3`}
            onClick={() =>
          ...
          >
            {colorMode === 'dark' ? (
              <svg aria-hidden="true" className="size-3.5 shrink-0" fill="none" viewBox="0 0 18 18">
